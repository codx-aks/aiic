...
const PHOTOS = ["/basketball.jpg"];

const HIGHLIGHTS = [
  "Facilitated by RECAL (Regional Engineering College Alumni Association)",
  "₹25 lakhs contributed towards campus sports infrastructure",
  "Full renovation of the Basketball and Tennis Courts",
  "Promotes student well-being, physical fitness and sporting culture on campus",
];
            ...
            <div className="relative rounded-3xl border border-emerald-900/30 bg-gradient-to-br from-emerald-950 to-stone-900 shadow-[0_14px_36px_rgba(0,0,0,.35)]">
              ...
              <div className="relative px-6 py-8 sm:px-10 sm:py-12">
                ...
                <h1 className="mt-1 font-serif text-3xl sm:text-4xl tracking-tight text-emerald-50">
                  Renovation of Basketball &amp; Tennis Courts
                </h1>
                <p className="mt-3 max-w-3xl text-emerald-100/90">
                  A ₹25 lakh contribution facilitated by RECAL to modernise campus sports infrastructure and promote student well-being.
                </p>
              </div>
            </div>
          </div>
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 pb-20 space-y-10">
        ...
        <section className="rounded-3xl border border-amber-200/60 bg-white/95 backdrop-blur p-6 md:p-8 shadow-[0_10px_28px_rgba(180,83,9,.08)]">
          ...
          <div className="prose prose-stone max-w-none mt-3 text-[15px] leading-7">
            <p>
              Alumni support also enhanced campus infrastructure and student welfare through several impactful initiatives.
              RECAL facilitated the renovation of the Basketball and Tennis Courts with a contribution of{" "}
              <strong>₹25 lakhs</strong>, improving sports infrastructure and promoting student well-being and physical
              fitness.
            </p>
          </div>
            ...
            {PHOTOS.map((src, i) => (
              ...
              >
                <div className="relative w-full aspect-[4/3]">
                  <img
                    src={src}
                    alt={`Basketball and Tennis Courts renovation photo ${i + 1}`}
