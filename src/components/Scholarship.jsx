...
export default function Scholarship() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50/25 to-orange-50/15">
      <PageHero
        crumbs={["Giving Back", "Scholarships"]}
        eyebrow="Giving Back · Student Success"
        title="Scholarship & Student Support Aid"
        blurb="Need- and merit-based support that keeps every NITT student focused on learning, research, and service."
      />
