...
const PHOTOS = ["/medical.jpg"];

const HIGHLIGHTS = [
  "₹67 lakhs worth of advanced medical equipment donated",
  "Strengthens campus healthcare at the NITT Hospital",
  "Benefits students, faculty, staff, and campus residents",
  "Upgrades medical services and healthcare support on campus",
];
            ...
            <div className="relative rounded-3xl border border-emerald-900/30 bg-gradient-to-br from-emerald-950 to-stone-900 shadow-[0_14px_36px_rgba(0,0,0,.35)]">
              ...
              <div className="relative px-6 py-8 sm:px-10 sm:py-12">
                ...
                <h1 className="mt-1 font-serif text-3xl sm:text-4xl tracking-tight text-emerald-50">
                  Advanced Medical Equipment for NITT Hospital
                </h1>
                <p className="mt-3 max-w-3xl text-emerald-100/90">
                  A ₹67 lakh alumni-community contribution strengthening campus healthcare for every member of the NITT family.
                </p>
              </div>
            </div>
          </div>
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 pb-20 space-y-10">
        ...
        <section className="rounded-3xl border border-amber-200/60 bg-white/95 backdrop-blur p-6 md:p-8 shadow-[0_10px_28px_rgba(180,83,9,.08)]">
          ...
          <div className="prose prose-stone max-w-none mt-3 text-[15px] leading-7">
            <p>
              In a significant step toward strengthening campus healthcare, the alumni community donated advanced medical
              equipment worth <strong>₹67 lakhs</strong> to the NITT Hospital, improving medical services and healthcare
              support for the institute&rsquo;s students, faculty, staff, and campus residents.
            </p>
          </div>
            ...
            {PHOTOS.map((src, i) => (
              ...
              >
                <div className="relative w-full aspect-[4/3]">
                  <img
                    src={src}
                    alt={`NITT Hospital medical equipment photo ${i + 1}`}
