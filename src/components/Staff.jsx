...
export default function Staff() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50/25 to-orange-50/15">
      <PageHero
        crumbs={["Giving Back", "Staff Support"]}
        eyebrow="Giving Back · Staff & Families"
        title="Staff Support"
        blurb="Compassionate support for the dedicated staff families whose everyday work keeps NIT Tiruchirappalli running."
      />
