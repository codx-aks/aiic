...
export default function PreviousEvents() {
  ...
  return (
    <div className="relative min-h-[60vh] bg-gradient-to-br from-stone-50 via-amber-50/30 to-orange-50/20">
      <PageHero
        crumbs={["Alumni Corner", "Previous Events"]}
        eyebrow="Alumni Calendar · Past"
        title="Previous Events"
        blurb="Jubilees, reunions and other events organised for our alumni community in the past."
      />
