        ...
        <div className="relative z-10 flex h-full items-center">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 w-full">
            ...
            <div className="mt-6 flex flex-wrap gap-3" data-reveal>
              ...
              >
                <span className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition bg-[linear-gradient(120deg,rgba(255, 255, 255, 0.08),transparent_40%)] animate-shine" />
                Explore AIIC
