...
export default function Infra() {
  return (
    <Section title="Infrastructure Development">
      <p> Help NIT Trichy expand and modernize its classrooms, labs, and common spaces. Your support builds cutting-edge facilities that fuel innovation, research, and a world-class learning environment for future engineers and leaders.
</p>
    </Section>
  );
}
