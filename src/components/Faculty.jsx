...
export default function Faculty() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50/25 to-orange-50/15">
      <PageHero
        crumbs={["Giving Back", "Faculty Support"]}
        eyebrow="Giving Back · Faculty Excellence"
        title="Faculty Support"
        blurb="Research chairs, young faculty awards, and well-being support that help NITT attract and sustain world-class teaching and research talent."
      />
